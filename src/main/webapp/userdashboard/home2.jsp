...
<html lang="en">
    <head>
        ...
        <link href="userdashboard/css/styles.css" rel="stylesheet" />
        <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/js/all.min.js" crossorigin="anonymous"></script>
    </head>
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand" href="../../indexEnglish.jsp"> <img src="userdashboard/images/shaka_white.png"></a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="userdashboard/home.jsp">
                                <div class="sb-nav-link-icon"><i class="fas fa-plus"></i></div>
                                ADD lost materials
                            </a>
                           
                              <a class="nav-link" href="userdashboard/listofthem.jsp">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                             View Posted materials
                            </a>
                         
                            <a class="nav-link" href="userdashboard/userupdate.jsp">
...
<p>With this for post the material here!</p>
...
<label for="lname">current location:</label>
    <input type="text" id="lname" name="current" placeholder="current location..">
    ...
    <input type="file" id="lname" name="image1" placeholder="current location.."><br><br>
     <label for="lname">insert it's second image here</label><br><br>
    <input type="file" id="lname" name="image2" placeholder="current location.."><br><br>
     <input type="hidden" id="lname" name="userId" value="${useid}"><br><br>
...
<textarea id="w3review" name="review" rows="4" 1\cols="50" placeholder="insert your comment">
    ...
    <input type="submit" value="Submit">
        ...
        <script src="userdashboard/js/scripts.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
        <script src="userdashboard/js/datatables-simple-demo.js"></script>
    </body>
    <style>
